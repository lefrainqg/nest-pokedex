...
export class PokemonService {
   ...
   async update(term: string, updatePokemonDto: UpdatePokemonDto) {
      try {
         ...
         await pokemon.updateOne(updatePokemonDto); // si no manda new:true retorna el obj viejo
   ...
   async remove(id: string) {
      ...
      // return { id };
      // const result = await this.pokemonModel.findByIdAndDelete(id); //elimina si existe
